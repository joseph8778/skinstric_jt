...
export default function AiCameraPage() {
    ...
    return (
        ...
        Please allow accesss or check your camera settings.
        </p>) : ( routerLoader ? (<PageLoader>PREPARING YOUR ANALYSIS</PageLoader>) : (
            ...
            <main > 
                <video ref={videoBlurRef} autoPlay playsInline className="absolute top-0 left-0 w-full h-full object-cover blur-sm "></video>
                   <video ref={videoRef} autoPlay playsInline  className="absolute top-0 left-0 w-full h-full object-cover [mask-image:radial-gradient(ellipse_25%_70%,#000_65%,transparent_75%)] z-0" />
         <ActionButton onClick={() => {if (timer === null) triggerTimer()}} icon={cameraIcon}></ActionButton>
