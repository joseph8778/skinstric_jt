...
export const ScanBtn = ({scanType = 'Camera'}:ScanBtnProps) => {
    const centerImg = {
        Camera: shutter,
        Gallery: gallery
    }
    ...
    <Image className="w-full h-full hover:scale-75 duration-500 cursor-pointer transition-all ease-in-out" src={centerImg[scanType]}  alt="shutterImage"/>
