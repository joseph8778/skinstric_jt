...
export default function BetterResultsDisclaimer({ parentProps = '' }:BetterResultsDisclaimerProps) {
    ...
    return (
        <div className={` flex flex-col justify-center sm:items-center items-start  w-full max-w-[550px] gap-5 font-[400] absolute bottom-[50] sm:top-auto -top-[300] sm:left-auto left-4 dark:text-white ${parentProps}`}>
